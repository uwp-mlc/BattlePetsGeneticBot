...
public enum SkillRegistry
{
	...
	private SkillRegistry()
	{
		...
		Skill rockThrow = new Skill(Skills.ROCK_THROW, 1);
		Skill scissorsPoke = new Skill(Skills.SCISSORS_POKE, 1);
		Skill paperCut = new Skill(Skills.PAPER_CUT, 1);
		Skill shootTheMoon = new Skill(Skills.SHOOT_THE_MOON, 6);
		Skill reversalOfFortune = new Skill(Skills.REVERSAL_OF_FORTUNE, 6);
